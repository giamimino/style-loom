...
export default function ShopButton() {
  return (
    <button
      className={`px-5.5 py-2.75 bg-dark-12 border border-dashed border-dark-25 text-white rounded-xl cursor-pointer relative hover:[&_>span]:w-1/2 hover:[&_>span]:h-1/2 transition-all duration-500 max-lg:px-4 max-md:px-3 max-sm:px-2 max-md:py-2 max-lg:text-sm max-md:text-xs`}
    >
